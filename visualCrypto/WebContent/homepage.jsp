...
<div id="container">
	...
	<div id="body">
		<ul id="nav">
			<li class="first"><a href="encrustation.jsp">Home page</a></li>
		...
		<div id="content"><div>
			...
			<form method="post" action="LoginDAO">            
					...
					<span style="color:red"><%=actv %></span>
						...
						<p><label>Keep me logged in:</label><input type="checkbox" value="remember" name="remember" id="check" class="regular-checkbox"></input></p>
...
<div style="display:none;"></div>
 ...
 response.sendRedirect("LoginDAO");}
